...
public class SolveEquationTest {
    ...
    public void testNoRoot() {
        ...
        assertEquals("No root", x.linearEquation(0, 10));
    }
...
public class MaxNumber1Test {
    ...
    void testFirstNumberIsMax() {
        finder.setNumber1(15); finder.setNumber2(12); finder.setNumber3(9);
        assertEquals(15, finder.max3(), "Số thứ nhất lớn nhất");
    }
